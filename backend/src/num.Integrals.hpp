 ...
 * 
 */
double trapezoid_quadrature_01(real_function function, double step_size);
/**
 * @brief Procedura licząca całkę przy pomocy metody Romberga
 *        dla złożonej kwadratury trapezów
 */
double romberg_quadrature_01(real_function function, size_t num_of_divisions, double tol);
